    ...
    return base.copyWith(
      ...
      textTheme: base.textTheme.copyWith(
        headlineLarge: const TextStyle(
            fontSize: 24, fontWeight: FontWeight.w600, color: glpiTextPrimary),
        headlineMedium: const TextStyle(
            fontSize: 20, fontWeight: FontWeight.w600, color: glpiTextPrimary),
        headlineSmall: const TextStyle(
            fontSize: 18, fontWeight: FontWeight.w600, color: glpiTextPrimary),
        titleLarge: const TextStyle(
            fontSize: 16, fontWeight: FontWeight.w600, color: glpiTextPrimary),
        titleMedium: const TextStyle(
            fontSize: 15, fontWeight: FontWeight.w500, color: glpiTextPrimary),
        bodyLarge: const TextStyle(
            fontSize: 15, fontWeight: FontWeight.w400, color: glpiTextPrimary),
        bodyMedium: const TextStyle(
            fontSize: 14, fontWeight: FontWeight.w400, color: glpiTextPrimary),
        bodySmall: const TextStyle(
            fontSize: 12,
            fontWeight: FontWeight.w400,
            color: glpiTextSecondary),
